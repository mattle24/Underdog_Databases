	...
	<div id='home-container' class='container'>
		<div class='row'>
			<article class='home-text-block col-md-4'>
				...
				<p>
					Grassroots Analytics is a data management and analytics platform built for small campaigns. We believe that data holds an underlying truth and every campaign, from village council to president, can make more effective decisions by utilizing data. Our goal is to create a platform so that any progressive campaign, no matter the size, can use data to inform their positions.
				</p>
			</article>
			...
			<article class='home-text-block col-md-4'>
				...
				<p>
					We created GrassRoots Analytics as a platform that any progressive campaign or group could use. The platform is free to use, although donations keep it running. To begin using the Grassroots platform, contact us by clicking the new campaign button above. We'll be in touch shortly about how we can help you bring a data-driven approach to your campaign.
				</p>
			</article>
		</div>
	</div> <!-- end container -->
